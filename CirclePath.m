...
phantom_pos = [0,5,30]; %set phantom position(x,y,z)
cut_angle = pi/2; % reconstruction cut angle
...
out = DAS_ultrasound_circle(pre_bf, radius, fs, channelSpacing, soundSpeed, xCoor, yCoor, phantom_pos, cut_angle);
